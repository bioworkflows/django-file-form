(function () {
	...
	*/
	...
	var RenderUploadFile = /*#__PURE__*/function () {
	  function RenderUploadFile(_ref) {
	    ...
	    classCallCheck(this, RenderUploadFile);

	    defineProperty$2(this, "container", void 0);

	    defineProperty$2(this, "input", void 0);
	...
	var utils = createCommonjsModule(function (module, exports) {
	  ...
	  exports.isObject = function (val) {
	    return val !== null && _typeof_1(val) === 'object' && !Array.isArray(val);
	  };
	...
	var MAX_LENGTH = constants.MAX_LENGTH,
	    POSIX_REGEX_SOURCE$1 = constants.POSIX_REGEX_SOURCE,
	...
	var expandRange = function expandRange(args, options) {
	  if (typeof options.expandRange === 'function') {
	    return options.expandRange.apply(options, toConsumableArray(args).concat([options]));
	  }
	...
	var parse = function parse(input, options) {
	  ...
	  var opts = _objectSpread$1({}, options);
	  ...
	  var extglobOpen = function extglobOpen(type, value) {
	    var token = _objectSpread$1(_objectSpread$1({}, EXTGLOB_CHARS[value]), {}, {
	      conditions: 1,
	      inner: ''
	    });
	      ...
	      if (opts.posix !== false && value === ':') {
	        ...
	        if (inner.includes('[')) {
	          ...
	          if (inner.includes(':')) {
	            ...
	            var posix = POSIX_REGEX_SOURCE$1[_rest];
	...
	var isObject$1 = function isObject(val) {
	  return val && _typeof_1(val) === 'object' && !Array.isArray(val);
	};
	/**
	...
	var picomatch = function picomatch(glob, options) {
	  ...
	  if (Array.isArray(glob)) {
	    ...
	    var arrayMatcher = function arrayMatcher(str) {
	      var _iterator = _createForOfIteratorHelper$1(fns),
	          _step;
	  ...
	  var isState = isObject$1(glob) && glob.tokens && glob.input;
	  ...
	  if (opts.ignore) {
	    var ignoreOpts = _objectSpread$2(_objectSpread$2({}, options), {}, {
	      ignore: null,
	      onMatch: null,
	      onResult: null
	    });
	...
	picomatch.parse = function (pattern, options) {
	  ...
	  return parse_1(pattern, _objectSpread$2(_objectSpread$2({}, options), {}, {
	    fastpaths: false
	  }));
	};
	/**
	...
	var AcceptedFileTypes = /*#__PURE__*/function () {
	  function AcceptedFileTypes(inputAccept) {
	    classCallCheck(this, AcceptedFileTypes);

	    defineProperty$2(this, "extensions", void 0);

	    defineProperty$2(this, "mimeTypes", void 0);

	    var _parseInputAccept = parseInputAccept(inputAccept),
	        _parseInputAccept2 = slicedToArray(_parseInputAccept, 2),
	...
	var getFileFromFileEntry = /*#__PURE__*/function () {
	  var _ref2 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(fileEntry) {
	      ...
	      while (1) {
	        switch (_context3.prev = _context3.next) {
	          case 0:
	            ...
	            _context3.prev = 3;
	            _iterator = asyncIterator(entries);
	      ...
	      while (1) {
	        switch (_context4.prev = _context4.next) {
	          case 0:
	            ...
	            entries = toConsumableArray(dataTransfer.items).map(function (item) {
	...
	var DropArea = function DropArea(_ref5) {
	  ...
	  defineProperty$2(this, "acceptedFileTypes", void 0);

	  defineProperty$2(this, "container", void 0);

	  defineProperty$2(this, "onUploadFiles", void 0);

	  defineProperty$2(this, "onDrop", function (e) {
	    var dragEvent = e;
	...
	var S3Upload = /*#__PURE__*/function (_BaseUpload) {
	  ...
	  function S3Upload(_ref) {
	    ...
	    defineProperty$2(assertThisInitialized(_this), "onError", void 0);

	    defineProperty$2(assertThisInitialized(_this), "onProgress", void 0);

	    defineProperty$2(assertThisInitialized(_this), "onSuccess", void 0);

	    defineProperty$2(assertThisInitialized(_this), "chunkState", void 0);

	    defineProperty$2(assertThisInitialized(_this), "chunks", void 0);

	    defineProperty$2(assertThisInitialized(_this), "createdPromise", void 0);

	    defineProperty$2(assertThisInitialized(_this), "csrfToken", void 0);

	    defineProperty$2(assertThisInitialized(_this), "endpoint", void 0);

	    defineProperty$2(assertThisInitialized(_this), "file", void 0);

	    defineProperty$2(assertThisInitialized(_this), "key", void 0);

	    defineProperty$2(assertThisInitialized(_this), "parts", void 0);

	    defineProperty$2(assertThisInitialized(_this), "s3UploadDir", void 0);

	    defineProperty$2(assertThisInitialized(_this), "uploadId", void 0);

	    defineProperty$2(assertThisInitialized(_this), "uploading", void 0);
	...
	var BaseUploadedFile = /*#__PURE__*/function (_BaseUpload) {
	  inherits(BaseUploadedFile, _BaseUpload);

	  var _super = _createSuper$1(BaseUploadedFile);
	  ...
	  function BaseUploadedFile(_ref) {
	    ...
	    defineProperty$2(assertThisInitialized(_this), "id", void 0);
	...
	var PlaceholderFile = /*#__PURE__*/function (_BaseUploadedFile) {
	  inherits(PlaceholderFile, _BaseUploadedFile);
	...
	var UploadedS3File = /*#__PURE__*/function (_BaseUploadedFile2) {
	  inherits(UploadedS3File, _BaseUploadedFile2);
	  ...
	  function UploadedS3File(initialFile, uploadIndex) {
	    ...
	    defineProperty$2(assertThisInitialized(_this2), "key", void 0);

	    _this2.key = initialFile.name;
	    return _this2;
	  }

	  createClass(UploadedS3File, [{
	    key: "getInitialFile",
	    value: function getInitialFile() {
	      return {
	        id: this.id,
	...
	var UploadedTusFile = /*#__PURE__*/function (_BaseUploadedFile3) {
	  inherits(UploadedTusFile, _BaseUploadedFile3);
	  ...
	  function UploadedTusFile(_ref2) {
	    ...
	    defineProperty$2(assertThisInitialized(_this3), "csrfToken", void 0);

	    defineProperty$2(assertThisInitialized(_this3), "url", void 0);
	...
	function toString$2(stringify) {
	  ...
	  query = 'object' === _typeof_1(url.query) ? stringify(url.query) : url.query;
	...
	var DetailedError = /*#__PURE__*/function (_Error) {
	  ...
	  function DetailedError(message) {
	    ...
	    _classCallCheck$1(this, DetailedError);
	...
	var BaseUpload$1 = /*#__PURE__*/function () {
	  function BaseUpload(file, options) {
	    _classCallCheck$2(this, BaseUpload); // Warn about removed options from previous versions
	  ...
	  _createClass$1(BaseUpload, [{
	    ...
	    value: function _startParallelUpload() {
	      ...
	      var uploads = parts.map(function (part, index) {
	        ...
	        return _this3._source.slice(part.start, part.end).then(function (_ref) {
	          ...
	          return new Promise(function (resolve, reject) {
	            ...
	            var options = _objectSpread$3({}, _this3.options, {
	              ...
	              headers: _objectSpread$3({}, _this3.options.headers, {
	      ...
	      Promise.all(uploads).then(function () {
	        ...
	        log$2("Created upload at ".concat(_this3.url));
	    ...
	    value: function _startSingleUpload() {
	      ...
	      if (this.url != null) {
	        log$2("Resuming upload from previous URL: ".concat(this.url));
	      ...
	      if (this.options.uploadUrl != null) {
	        log$2("Resuming upload from provided URL: ".concat(this.options.url));
	    ...
	    value: function _createUpload() {
	      ...
	      promise.then(function (res) {
	        ...
	        log$2("Created upload at ".concat(_this6.url));
	    ...
	    value: function terminate(url) {
	      ...
	      return sendRequest(req, null, options).then(function (res) {
	        ...
	        var newOptions = _objectSpread$3({}, options, {
	...
	BaseUpload$1.defaultOptions = defaultOptions;
	...
	var NoopUrlStorage = /*#__PURE__*/function () {
	  function NoopUrlStorage() {
	    _classCallCheck$3(this, NoopUrlStorage);
	  }

	  _createClass$2(NoopUrlStorage, [{
	    key: "listAllUploads",
	...
	var FileSource = /*#__PURE__*/function () {
	  ...
	  function FileSource(file) {
	    _classCallCheck$6(this, FileSource);

	    this._file = file;
	    this.size = file.size;
	  }

	  _createClass$5(FileSource, [{
	    key: "slice",
	...
	var StreamSource = /*#__PURE__*/function () {
	  function StreamSource(reader, chunkSize) {
	    _classCallCheck$6(this, StreamSource);
	...
	*/
	...
	var FileReader$1 = /*#__PURE__*/function () {
	  function FileReader() {
	    _classCallCheck$6(this, FileReader);
	  }

	  _createClass$5(FileReader, [{
	    key: "openFile",
	...
	var defaultOptions$1 = _objectSpread$4({}, BaseUpload$1.defaultOptions, {
	...
	var Upload = /*#__PURE__*/function (_BaseUpload) {
	  _inherits$2(Upload, _BaseUpload);

	  var _super = _createSuper$3(Upload);

	  function Upload() {
	    var file = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
	    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

	    _classCallCheck$7(this, Upload);

	    options = _objectSpread$4({}, defaultOptions$1, {}, options);
	    return _super.call(this, file, options);
	  }

	  _createClass$6(Upload, null, [{
	    key: "terminate",
	    value: function terminate(url, options, cb) {
	      options = _objectSpread$4({}, defaultOptions$1, {}, options);
	      return BaseUpload$1.terminate(url, options, cb);
	    }
	  }]);
	...
	var TusUpload = /*#__PURE__*/function (_BaseUpload) {
	  inherits(TusUpload, _BaseUpload);
	  ...
	  function TusUpload(_ref) {
	    ...
	    defineProperty$2(assertThisInitialized(_this), "upload", void 0);

	    defineProperty$2(assertThisInitialized(_this), "csrfToken", void 0);

	    defineProperty$2(assertThisInitialized(_this), "handleError", function (error) {
	      if (_this.onError) {
	        _this.onError(error);
	      } else {
	        throw error;
	    ...
	    defineProperty$2(assertThisInitialized(_this), "handleProgress", function (bytesUploaded, bytesTotal) {
	      if (_this.onProgress) {
	        _this.onProgress(bytesUploaded, bytesTotal);
	      }
	    });

	    defineProperty$2(assertThisInitialized(_this), "handleSucces", function () {
	      if (_this.onSuccess) {
	        _this.onSuccess();
	      }
	    });

	    defineProperty$2(assertThisInitialized(_this), "addCsrTokenToRequest", function (request) {
	...
	var FileField = /*#__PURE__*/function () {
	  function FileField(_ref) {
	    ...
	    classCallCheck(this, FileField);

	    defineProperty$2(this, "callbacks", void 0);

	    defineProperty$2(this, "chunkSize", void 0);

	    defineProperty$2(this, "csrfToken", void 0);

	    defineProperty$2(this, "eventEmitter", void 0);

	    defineProperty$2(this, "fieldName", void 0);

	    defineProperty$2(this, "form", void 0);

	    defineProperty$2(this, "formId", void 0);

	    defineProperty$2(this, "multiple", void 0);

	    defineProperty$2(this, "nextUploadIndex", void 0);

	    defineProperty$2(this, "prefix", void 0);

	    defineProperty$2(this, "renderer", void 0);

	    defineProperty$2(this, "retryDelays", void 0);

	    defineProperty$2(this, "s3UploadDir", void 0);

	    defineProperty$2(this, "supportDropArea", void 0);

	    defineProperty$2(this, "uploads", void 0);

	    defineProperty$2(this, "uploadUrl", void 0);

	    defineProperty$2(this, "uploadFiles", /*#__PURE__*/function () {
	      var _ref2 = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(files) {
	    ...
	    defineProperty$2(this, "onClick", function (e) {
	      var target = e.target;
	    ...
	    defineProperty$2(this, "handleError", function (upload, error) {
	  ...
	  createClass(FileField, [{
	    ...
	    key: "uploadFile",
	    value: function () {
	      var _uploadFile = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(file) {
	        var _this3 = this;
	    ...
	    value: function () {
	      var _removeExistingUpload = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(upload) {
	        var element;
	        return regenerator.wrap(function _callee3$(_context3) {
	          while (1) {
	            switch (_context3.prev = _context3.next) {
	...
	var initFormSet = function initFormSet(form, optionsParam) {
	  ...
	  for (var i = 0; i < formCount; i += 1) {
	    ...
	    initUploadFields(form, _objectSpread$5(_objectSpread$5({}, options), {}, {
